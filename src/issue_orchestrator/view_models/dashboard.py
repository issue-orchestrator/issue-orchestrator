...
def _extract_circuit_breaker_status(orchestrator: Any) -> list[dict[str, Any]]:
    """Extract provider circuit breaker states for the dashboard."""
...
def build_dashboard_view_model(
    ...
    provider_circuit_breakers = _extract_circuit_breaker_status(orchestrator)
