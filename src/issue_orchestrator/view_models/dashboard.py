...
def _get_open_circuits(orchestrator) -> list[dict[str, Any]]:
    """Collect provider circuit breaker states for the dashboard."""
...
def build_dashboard_view_model(
    ...
    return DashboardViewModel(
        ...
        open_circuits=_get_open_circuits(orchestrator),
    )
