...
def build_dashboard_view_model(
    ...
    provider_circuit_breaker_provider: Callable[[Any], list[dict[str, Any]]] | None = None,
) -> DashboardViewModel:
    ...
    cb_provider = provider_circuit_breaker_provider or _get_provider_circuit_breakers
    provider_circuit_breakers = cb_provider(orchestrator)
