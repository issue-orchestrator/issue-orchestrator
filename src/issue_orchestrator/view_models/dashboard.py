...
def _get_circuit_breaker_states(orchestrator) -> list[dict[str, Any]]:
    """Collect provider circuit breaker states from the orchestrator deps."""
    try:
...
def build_dashboard_view_model(
    ...
    provider_circuit_breakers = _get_circuit_breaker_states(orchestrator)
