...
class DashboardViewModel:
    ...
    def dashboard_data(self) -> dict[str, Any]:
        ...
        provider_circuit_breaker = self.scope_summary.get("provider_circuit_breaker", {})
        return {
            ...
            "providerCircuitBreaker": provider_circuit_breaker,
        }
...
def _get_provider_circuit_breaker_status(orchestrator) -> dict[str, Any]:
    """Get provider circuit breaker status for UI display."""
    ...
    try:
        ...
        return {
            "circuits": circuits,
            "hasOpenCircuits": any(c["isOpen"] for c in circuits),
        }
    except Exception:
        # UI should still render even if circuit breaker read fails
        return {}
...
def build_dashboard_view_model(
    ...
    provider_circuit_breaker = _get_provider_circuit_breaker_status(orchestrator)
