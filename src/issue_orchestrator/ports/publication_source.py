...
from .working_copy import (
    BranchCommitMessagesResult, BranchPathsResult, BranchTextFilesResult, DiffResult,
)
...
class PublicationSourceReader(Protocol):
    ...
    def branch_commit_messages_against_base(self, worktree: Path, base_ref: str) -> BranchCommitMessagesResult: ...
