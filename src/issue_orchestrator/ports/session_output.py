...
class SessionOutput(Protocol):
    ...
    def start_run(
        ...
        Args:
            ...
            retention_days: Requested retention metadata in days. Zero records
                an immediate deadline; it does not preserve artifacts after
                their owning worktree is deleted.
