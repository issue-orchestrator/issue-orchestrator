...
def _run_interactive_round(
    runner: AgentRunner,  # noqa: ARG001 – kept for API compat
    spec: AgentSpec,
    response_file: Path,
) -> AgentResult:
    ...
    so Claude starts working immediately.  We poll for the response file
    ...
    log_fh = open(log_path, "ab") if log_path else subprocess.DEVNULL  # noqa: SIM115
