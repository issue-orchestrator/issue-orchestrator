    ...
    tech_lead_findings_promote: str = Field(
        ...
        json_schema_extra={
            ...
            "doc_notes": (
                ...
                "owner/repo target, with route.default as the catch-all. When "
                "a foreign repo needs a different credential, "
                "tech_lead.findings.target_auth maps that owner/repo to an "
                "explicit token_env, keyring reference, or GitHub App "
                "installation; startup checks and filing use that same "
                "credential. A "
