...
def check_guardrails_in_worktree_impl(
    ...
    # Run wrapper-based guardrail checks
    checks.extend(_check_wrapper_guards(worktree_path, runner, env))
...
def _check_wrapper_guards(
    worktree_path: Path,
    runner: CommandRunner,
    env: dict,
) -> list[Check]:
    """Check that wrapper scripts block dangerous commands."""
    checks: list[Check] = []
    ...
    # Check: gh issue create is blocked
    checks.append(test_blocked(
