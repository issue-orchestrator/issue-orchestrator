...
class PendingCleanup:
    ...
    code review or CTO review before closing tabs/removing worktrees.
    """
    issue_number: int
    pr_number: int
    pr_url: str
...
@dataclass
class PendingCTOReview:
    """A CTO batch review issue queued for processing.

    CTO reviews are treated as reviews (not work items) so they get
    processed with priority, alongside pending_reviews and pending_reworks.
    """
    issue_number: int  # The CTO review GitHub issue number
...
class OrchestratorState:
    ...
    pending_cto_reviews: list["PendingCTOReview"] = field(default_factory=list)  # CTO batch reviews waiting
