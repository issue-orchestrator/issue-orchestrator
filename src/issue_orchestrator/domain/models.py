...
if TYPE_CHECKING:
    ...
    # Imported under TYPE_CHECKING only: pending_work imports the Pending*
    # request types from this module, so a runtime import here would be a cycle.
    from .pending_work import InFlightWork
    from .tech_lead_proposal_creation import PendingTechLeadProposal
...
class TechLeadFacts:
    ...
    """
    pending_proposal_creations: tuple["PendingTechLeadProposal", ...] = ()
...
class OrchestratorState:
    ...
    # #6999 A1: claims taken off the queues above by sessions that are running
