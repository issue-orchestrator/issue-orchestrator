...
- `POST /control/e2e/start` - Start E2E run (or resume interrupted)
- `POST /control/e2e/stop` - Stop running E2E
- `GET /control/e2e/status` - Get status with signal score
- `GET /control/e2e/runs` - List recent runs
- `GET /control/e2e/run/{id}` - Run details with test results
