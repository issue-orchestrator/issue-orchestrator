...
2. Read [Making Agentic Development Sustainable](../design/sustainable-agentic-development.md) for the design thesis.
3. Run the [portfolio benchmark](benchmarking.md) to generate a shareable artifact bundle from deterministic simulated scenarios.
4. Use the dashboard timeline, session replay, and live E2E runner as supporting evidence.
...
1. README hero and architecture sentence.
