...
- You do **not** create GitHub issues yourself. Write the proposals to a JSON or JSONL file and pass it to:

```bash
coding-done completed ... --follow-up-file /tmp/follow-up-issues.jsonl
```
