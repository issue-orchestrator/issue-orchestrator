...
class StubWorkingCopy:
    ...
    def get_current_branch(self, worktree: Path) -> str | None:  # type: ignore - Union type narrowing limitation
        return "test-branch"
...
def test_timeout_observation_and_decision(tmp_path):
    ...
    observer = SessionObserver(
        ...
        events=events,
        session_runner=StubSessionRunner(),  # type: ignore - Union type narrowing limitation
    ...
    completion_processor = CompletionProcessor(
        ...
        git_adapter=StubGitAdapter(),  # type: ignore - Union type narrowing limitation
        session_output=session_output,
    )
