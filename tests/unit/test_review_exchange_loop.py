...
from issue_orchestrator.control.review_exchange_loop import _run_agent_round, run_review_exchange_loop
...
def test_review_exchange_run_manifest_includes_claude_log_dir(tmp_path: Path, monkeypatch) -> None:
    ...
    session_output.start_run.return_value = SimpleNamespace(run_dir=run_dir)
