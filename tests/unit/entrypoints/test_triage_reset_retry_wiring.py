"""Production-wiring tests for the triage ``reset_retry`` executor (#6777).

These exercise the real composition path — ``build_triage_reset_retry_executor``
...
from issue_orchestrator.control.triage_reset_retry import STALE_DOWNGRADE_MODE
...
from issue_orchestrator.entrypoints.triage_reset_retry_wiring import (
...
def _build(
    ...
    *,
    ...
    executor = build_triage_reset_retry_executor(orchestrator)
