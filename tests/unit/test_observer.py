...
class TestSessionObserverInit:
    ...
    def test_init_with_config(self, mock_config):
        ...
        monitor = SessionObserver(mock_config, mock_session_output)  # type: ignore - Union type narrowing limitation
    ...
    def test_init_with_session_machines(self, mock_config):
        ...
        monitor = SessionObserver(mock_config, mock_session_output, session_machines=machines)  # type: ignore - Union type narrowing limitation
        assert monitor.config == mock_config
    ...
    def test_init_session_machines_defaults_to_empty_dict(self, mock_config):
        ...
        monitor = SessionObserver(mock_config, mock_session_output, session_machines=None)  # type: ignore - Union type narrowing limitation
        assert monitor.session_machines == {}
