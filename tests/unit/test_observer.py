...
class TestHandleCompletion:
    ...
    def test_handle_completion_timed_out(
        ...
        """Test handle_completion for TIMED_OUT kills session and adds label."""
        ...
        mock_repository_host.add_label.assert_called()
        mock_repository_host.remove_label.assert_called()

    def test_handle_completion_failed(
        self, monitor, sample_session, mock_repository_host
    ):
        """Test handle_completion for FAILED adds blocked label."""
