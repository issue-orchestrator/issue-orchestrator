...
""")
    ...
    def test_blocks_when_list_dirty_files_returns_none(self, temp_worktree, monkeypatch, capsys):
...
""")
        ...
        monkeypatch.setattr(GitWorkingCopy, "list_dirty_files", lambda self, wt, mode: None)
