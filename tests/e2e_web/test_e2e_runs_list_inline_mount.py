...
_STUB_RUN_DETAIL: dict[str, object] = {
    ...
    "results_by_category": {
        "untriaged": [
            {
                ...
                "case_id": "tests/e2e/test_a.py::test_untracked_failure",
                "label": "test_untracked_failure",
                "display_name": "test_untracked_failure",
        ...
        "passed": [
            {
                "nodeid": "tests/e2e/test_c.py::test_one",
                "case_id": "tests/e2e/test_c.py::test_one",
                "label": "test_one",
                "display_name": "test_one",
                "suite_name": "tests/e2e/test_c.py",
                "result_source": "junit_xml",
                "outcome": "passed",
    ...
    "results_summary": {"total": 2, "passed": 1, "skipped": 0, "untriaged": 1, "has_issue": 0, "flaky": 0, "fixed": 0, "quarantined": 0},
    "artifacts": [],
    "reports": [],
    "artifact_diagnostic": {
        "state": "collected",
        ...
        **_STUB_RUN_DETAIL,
        ...
        "results_by_category": {
                **_STUB_RUN_DETAIL["results_by_category"],
                "untriaged": [
                    {
                        **_STUB_RUN_DETAIL["results_by_category"]["untriaged"][0],
                        "nodeid": "tests/row_a.py::test_alpha",
                        "case_id": "tests/row_a.py::test_alpha",
                        "label": "test_alpha",
                        "display_name": "test_alpha",
                        "suite_name": "tests/row_a.py",
                    },
                ],
        },
    }
                ...
                "untriaged": [
                    {
                        **_STUB_RUN_DETAIL["results_by_category"]["untriaged"][0],
                        ...
                        "case_id": "tests/row_b.py::test_bravo",
                        "label": "test_bravo",
                        "display_name": "test_bravo",
                        "suite_name": "tests/row_b.py",
                    },
                ],
        },
    }
