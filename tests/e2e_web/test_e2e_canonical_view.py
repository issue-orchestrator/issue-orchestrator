...
_STUB_RUN_DETAIL: dict[str, object] = {
    ...
    "results_by_category": {
        ...
        "fixed": [],
        "passed": [
            _test_case("tests/e2e/test_c.py::test_one", "passed", category="healthy", result_category="passed"),
            _test_case("tests/e2e/test_c.py::test_two", "passed", category="healthy", result_category="passed"),
            _test_case("tests/e2e/test_d.py::test_one", "passed", category="healthy", result_category="passed"),
        ],
        "quarantined": [],
        "skipped": [
            _test_case(
                "tests/e2e/test_e.py::test_pending",
                "skipped",
                failure_summary="skip(reason='waiting on upstream API key'): pending env var",
                category="skipped",
                result_category="skipped",
            ),
        ],
    },
    "results_summary": {"total": 6, "passed": 3, "skipped": 1, "untriaged": 1, "has_issue": 1, "flaky": 0, "fixed": 0, "quarantined": 0},
    "artifacts": [],
    "reports": [],
    "artifact_diagnostic": {"state": "collected", "collected_count": 0, "configured_glob_count": 0},
    "issue_number": 1,
    "title": "E2E canonical viewer fixture",
    "issue_url": "https://example.invalid/issues/1",
    "issue_affordances": [],
    "lifecycle": {
        "kind": "dashboard",
        "subject": {"kind": "dashboard", "id": "dashboard", "label": "Dashboard"},
        "current": {
    ...
    "phase_toc": [],
    "cycles": [],
    "summary": {"status": "failed", "last_event": "", "event_count": 0},
    "actions": [],
    "status_explanation": "",
    "attempts": [],
    "timeline_steps": [],
...
def test_e2e_run_modal_mounts_canonical_viewer_with_plugin_and_aria(
    ...
    page.evaluate(
        ...
        "        attempt_number: 1, expanded: true, outcome: { label: 'Completed', tone: 'passed' }, "
